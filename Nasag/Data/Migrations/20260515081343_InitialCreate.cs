        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Occupation = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeePlans_Grades_GradeId",
                        column: x => x.GradeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameAr = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    MaxMark = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    PassMark = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    GradeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentFees_FeePlans_FeePlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Installments_StudentFees_StudentFeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeePlans_AcademicYearId",
                table: "FeePlans",
                column: "AcademicYearId");

            migrationBuilder.CreateIndex(
                name: "IX_FeePlans_GradeId",
                table: "FeePlans",
                column: "GradeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Installments_StudentFeeId",
                table: "Installments",
                column: "StudentFeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_StudentId_SubjectId_ExamId",
                table: "Marks",
                columns: new[] { "StudentId", "SubjectId", "ExamId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_GradeId_AcademicYearId_NameAr",
                table: "Sections",
                columns: new[] { "GradeId", "AcademicYearId", "NameAr" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentFees_FeePlanId",
                table: "StudentFees",
                column: "FeePlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_GradeId_NameAr",
                table: "Subjects",
                columns: new[] { "GradeId", "NameAr" },
                unique: true);
